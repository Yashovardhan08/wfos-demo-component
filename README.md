...
* csw-yashoassembly - an assembly that talks to the Yasho HCD
* csw-yashohcd - an HCD that talks to the Yasho hardware
* csw-yashodeploy - for starting/deploying HCDs and assemblies
...
```
sbt "csw-yashodeploy/runMain csw.yashodeploy.YashoContainerCmdApp --local ./src/main/resources/YashohcdStandalone.conf"
```

* Start the HCD and assembly in a container using the Java implementations:

```
sbt "csw-yashodeploy/runMain csw.yashodeploy.YashoContainerCmdApp --local ./src/main/resources/JYashoContainer.conf"
```
